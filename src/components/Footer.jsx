...
// Assuming you are using react-router-dom for internal navigation
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="md:col-span-12 lg:col-span-5 flex flex-col items-start">
            <Link to="/" className="mb-6 transition-transform hover:scale-[1.02] active:scale-[0.98]">
              <img 
                src="/logo.png" 
                alt="123Greetings" 
          ...
          <div className="md:col-span-6 lg:col-span-3 lg:col-start-7">
            ...
            <ul className="space-y-4">
              <li>
                <Link to="/" className="text-slate-500 hover:text-rose-600 font-light transition-colors hover:translate-x-1 inline-block">Corporate Info</Link>
              </li>
              <li>
                <Link to="/media-kit" className="text-slate-500 hover:text-rose-600 font-light transition-colors hover:translate-x-1 inline-block">Media Kit</Link>
              </li>
              <li>
                <Link to="/press-releases" className="text-slate-500 hover:text-rose-600 font-light transition-colors hover:translate-x-1 inline-block">Press Releases</Link>
              </li>
            </ul>
          </div>

          {/* Column 3: Legal Links - NOW LINKED INTERNALLY */}
          <div className="md:col-span-6 lg:col-span-3">
            <h3 className="font-semibold text-slate-900 mb-6 tracking-wide uppercase text-sm">Legal</h3>
            <ul className="space-y-4">
              <li>
                <Link to="/copyright-policy" className="text-slate-500 hover:text-rose-600 font-light transition-colors hover:translate-x-1 inline-block">Copyright Policy</Link>
              </li>
              <li>
                <Link to="/terms-of-use" className="text-slate-500 hover:text-rose-600 font-light transition-colors hover:translate-x-1 inline-block">Terms of Use</Link>
              </li>
              <li>
                <Link to="/privacy-policy" className="text-slate-500 hover:text-rose-600 font-light transition-colors hover:translate-x-1 inline-block">Privacy Policy</Link>
              </li>
              <li>
                <Link to="/cookie-policy" className="text-slate-500 hover:text-rose-600 font-light transition-colors hover:translate-x-1 inline-block">Cookie Policy</Link>
              </li>
              <li>
                <Link to="/contact-us" className="text-slate-500 hover:text-rose-600 font-light transition-colors hover:translate-x-1 inline-block">Contact Us</Link>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-slate-200/80 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-sm text-slate-400 font-light text-center md:text-left">
            <p>Copyright &copy; {new Date().getFullYear()} 123Greetings.com</p>
